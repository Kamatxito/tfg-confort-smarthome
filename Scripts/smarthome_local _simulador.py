# Este script realiza las mismas funciones que el simulador principal, pero para trabajar fuera de la Smarthome.
# Se utilizan valores predefinidos en cada parámetro.
...
while (True):
    ...
    tempInterior = 20 #GET_datos(parametros_GET)
    tempInterior += 0.0
    ...
    tempExterior = 15 #GET_datos(parametros_GET)
